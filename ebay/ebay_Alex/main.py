...
def get_pagination():
    # Заголовки из curl-запроса (нужно добавить их в параметры функции или создать глобальные переменные)
    # Базовый URL
    ...
    while current_url:
        ...
        if page_count % 100 == 0:
            ...
            temp_df.to_csv(f"all_urls_page_{page_count}.csv", index=False)
            logger.info(
