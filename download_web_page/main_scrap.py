...
def pars_htmls():
    ...
    for html_file in html_directory.glob("*.html"):
        ...
        name = firstname = lastname = image = phone = fax = address = clinic_name = None
        doctor_specialization = incuranse = email = web = languages = transport_list = (
            None
        )
        ...
        if doctor_specializations:
            doctor_specialization = [
                li.get_text(strip=True) for li in doctor_specializations.find_all("li")
            ]
        ...
        if languages_raw:
            languages = [li.get_text(strip=True) for li in languages_raw.find_all("li")]
        ...
        if transport_raw:
            ...
            transport_list = [line.strip() for line in transport_list if line.strip()]
