...
name_site = "hurtowniamuzyczna.pl"
...
def extract_product_data(data):
    ...
    title = data.find("h3", attrs={"itemprop": "name"})
    title = title.text.strip()
    price = data.find("span", attrs={"class": "priceDefInput"})
    if price:
    ...
    article_number = data.find("meta", attrs={"itemprop": "productID"})
    if article_number:
    ...
    availability_tag = data.find("div", attrs={"class": "availability_"})
