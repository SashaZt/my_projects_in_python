...
def extract_product_data(data):
    ...
    article_number = data.find("span", attrs={"itemprop": "sku"})
    article_number = article_number.text.strip() if article_number else None

    availability_tag = data.find("div", attrs={"id": "product-availability"})
    if availability_tag:
        availability = availability_tag.find("span").text.strip()
    else:
