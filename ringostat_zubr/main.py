...
app.add_middleware(
    ...
    allow_methods=["GET", "POST", "OPTIONS",
                   "PUT", "DELETE"],  # Явно указать методы
...
if __name__ == "__main__":
    ...
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=5000, ssl_keyfile="/root/ringostat_zubr/key.pem",
                ssl_certfile="/root/ringostat_zubr/cert.pem", log_level="debug")
