...
output_csv = data_directory / "all_urls.csv"
file_proxy = configuration_directory / "1000 ip.txt"
...
def get_html(url, proxys):
    proxy = random.choice(proxys)  # Выбираем случайный прокси
...
if __name__ == "__main__":
    ...
    while True:
        ...
        with ThreadPoolExecutor(max_workers=max_workers) as executor:
            future_to_url = {
                executor.submit(get_html, url, proxies): url for url in all_urls
            }
