...
const processedProducts = products.map((product, index) => ({
    ...
    totalPrice: (product.price || 0) * (product.amount || 0), // Вычисляем общую стоимость
}));
...
const output = {
    ...
    receiverTown: shortTownName, // Обрезанное название города
    receiverAddress: data.shipping_address || null,
    paymentMethod: getTextFromOptions('payment_method', data.payment_method, metaFields),
