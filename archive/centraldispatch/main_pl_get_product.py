...
# Скачиваем компании в папку products
import asyncio
...
async def run():
    ...
    url_start = "https://id.centraldispatch.com/Account/Login?ReturnUrl=%2Fconnect%2Fauthorize%2Fcallback%3Fclient_id%3Dcentraldispatch_authentication%26scope%3Dlisting_service%2520offline_access%2520openid%26response_type%3Dcode%26redirect_uri%3Dhttps%253A%252F%252Fwww.centraldispatch.com%252Fprotected"
        ...
        for v in values:
            ...
            if not os.path.isfile(filename_html):
                ...
                await page.wait_for_selector(
                    f"xpath={xpath_page_header}", timeout=timeout
                )
