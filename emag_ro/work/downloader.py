...
class Downloader:
    ...
    def get_all_page_json(self, url):
        ...
        if response.status_code == 200:
            ...
            max_retries = 10  # Максимальное количество проверок статуса
            retry_delay = 5  # Задержка между проверками (в секундах)
            ...
            for _ in range(max_retries):
                ...
                if job_status == "finished":
                    ...
                    json_file = self.html_files_directory / f"{name_file}.json"
