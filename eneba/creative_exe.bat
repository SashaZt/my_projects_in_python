@echo off
chcp 65001 > nul
REM Файл для сборки исполняемого файла из main_controller.py и очистки временных папок
...
pyinstaller --onefile --name=main --add-data "config;config" --add-data "data;data" .\src\main_controller.py
