...
class LoggerManager:
    ...
    def setup_logging(self, config: "Config" = None) -> logger:
    ...
    def reconfigure(self, config: "Config" = None):
        ...
        self._configured = False
        return self.setup_logging(config)
...
def setup_logging(config: "Config" = None):
    ...
    return _logger_manager.setup_logging(config)
...
def reconfigure_logging(config: "Config" = None):
    """Пересконфигурировать логгер"""
    return _logger_manager.reconfigure(config)
