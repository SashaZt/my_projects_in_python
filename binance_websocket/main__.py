# # Постоянное подключение к websocket с поянной записью json
# import pandas as pd
...
#     global current_bids_file, current_asks_file
#     bids = data["bids"]
#     asks = data["asks"]
...
#     async with aiofiles.open(current_bids_file, "a", encoding="utf-8") as file:
#         for bid in bids:
#             price, quantity = bid
#             formatted_data_bids = {
#                 "Цена": price,
...
#     async with aiofiles.open(current_asks_file, "a", encoding="utf-8") as file:
#         for ask in asks:
#             price, quantity = ask
#             formatted_data_asks = {
#                 "Цена": price,
...
#             async with aiofiles.open(current_trade_file, "a", encoding="utf-8") as file:
...
#         await asyncio.gather(task_depth, task_trade, task_update_files)
