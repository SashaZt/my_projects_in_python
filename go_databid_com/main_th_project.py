...
json_project_diretory = current_directory / "json_project"
...
json_project_diretory.mkdir(exist_ok=True, parents=True)
...
def get_json_projectInvolvement(pr_id):
    cookies = {
    ...
    file_name = json_project_diretory / f"{pr_id}_ProjectID.json"
    if file_name.exists():
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        future_to_id = {
            executor.submit(get_json_projectInvolvement, pr_id): pr_id
