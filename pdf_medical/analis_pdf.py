...
def process_single_crop_area():
    crop_areas_01 = [(75, 70, 800, 255)]
    crop_areas_3a = [(1620, 70, 2320, 120)]
    crop_areas_3b = [(1620, 120, 2320, 170)]
    crop_areas_4 = [(2320, 120, 2475, 170)]
    crop_areas_5 = [(1538, 215, 1828, 260)]
    crop_areas_6a = [(1828, 215, 2030, 260)]
    crop_areas_6b = [(2032, 215, 2235, 260)]
    crop_areas_8b = [(110, 310, 950, 360)]
    crop_areas_9a = [(1280, 265, 2470, 310)]
    crop_areas_9b = [(980, 310, 1905, 360)]
    crop_areas_9c = [(1945, 310, 2030, 360)]
    crop_areas_9d = [(2060, 310, 2350, 360)]
    crop_areas_10 = [(75, 410, 340, 460)]
    crop_areas_11 = [(340, 410, 425, 460)]
    crop_areas_12 = [(425, 410, 600, 460)]
    crop_areas_13 = [(605, 410, 690, 460)]
    crop_areas_14 = [(695, 410, 775, 460)]
    crop_areas_15 = [(780, 410, 865, 460)]
    crop_areas_16 = [(870, 410, 950, 460)]
    crop_areas_17 = [(955, 410, 1040, 460)]
    crop_areas_31a = [(75, 510, 165, 560)]
    crop_areas_31b = [(170, 510, 360, 560)]
    crop_areas_32a = [(375, 510, 450, 560)]
    crop_areas_32b = [(465, 510, 655, 560)]
    crop_areas_35a = [(1250, 510, 1325, 560)]
    crop_areas_35b = [(1340, 510, 1530, 560)]
    crop_areas_35c = [(1540, 510, 1740, 560)]
    crop_areas_38a = [(110, 610, 1290, 660)]
    crop_areas_38b = [(110, 660, 1290, 710)]
    crop_areas_38c = [(110, 710, 1290, 760)]
    crop_areas_38d = [(110, 760, 1290, 810)]
    crop_areas_38e = [(90, 810, 1290, 850)]
    crop_areas_39a = [(1340, 660, 1410, 845)]
    crop_areas_39b = [(1430, 660, 1650, 845)]
    crop_areas_39c = [(1650, 660, 1708, 845)]
    crop_areas_40a = [(1717, 660, 1793, 845)]
    crop_areas_40b = [(1805, 660, 2030, 845)]
    crop_areas_40c = [(2040, 660, 2088, 845)]
    crop_areas_41 = [(2100, 660, 2175, 845)]
    crop_areas_41a = [(2190, 660, 2410, 845)]
    crop_areas_41b = [(2410, 660, 2465, 845)]
    crop_areas_42 = [(75, 900, 200, 1900)]
    crop_areas_43 = [(220, 900, 750, 1900)]
    ...
    crop_areas_42_1 = [(75, 900, 200, 940)]
    crop_areas_42_2 = [(75, 940, 200, 1000)]
    crop_areas_42_3 = [(75, 1000, 200, 1040)]
    crop_areas_42_4 = [(75, 1040, 200, 1100)]
    crop_areas_42_5 = [(75, 1100, 200, 1140)]
    crop_areas_42_6 = [(75, 1140, 200, 1200)]
    crop_areas_42_7 = [(75, 1200, 200, 1240)]
    crop_areas_42_8 = [(75, 1240, 200, 1300)]
    crop_areas_43_1 = [(220, 900, 940, 940)]
    crop_areas_43_2 = [(220, 940, 940, 1000)]
    crop_areas_43_3 = [(220, 1000, 940, 1040)]
    crop_areas_43_4 = [(220, 1040, 940, 1100)]
    crop_areas_43_5 = [(220, 1100, 940, 1140)]
    crop_areas_43_6 = [(220, 1140, 940, 1200)]
    crop_areas_43_7 = [(220, 1200, 940, 1240)]
    crop_areas_43_8 = [(220, 1240, 940, 1300)]
    crop_areas = [(220, 1240, 940, 1300)]
